...
if __name__=='__main__':
    file_name = r'C:\Users\Apparatett\Desktop\lulu\results\test5\12_pred_ycb_hsv.png'
    # img=io.imread(file_name)
    img = cv2.imread(r'C:\Users\Apparatett\Desktop\lulu\results\test5\12_pred_ycb_hsv.png')
    img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
    img_out = sat(img)
    img_out = cv2.cvtColor(img_out, cv2.COLOR_RGB2BGR)
    cv2.imshow('d',img_out)
    cv2.waitKey()
# plt.figure()
